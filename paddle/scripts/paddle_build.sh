...
set +x
        ...
        secondary_tetrad_parallel_job=$(echo $output | cut -d ";" -f 4)
        ...
        card_test "$single_card_tests_high_parallel" 1 28       # run cases the most each time with single GPU
        card_test "$single_card_tests_secondary_high_parallel" 1 15
        card_test "$single_card_tests_tetrad_parallel" 1 10         # run cases 2 job each time with single GPU
        card_test "$single_card_tests_secondary_tetrad_parallel" 1 5
